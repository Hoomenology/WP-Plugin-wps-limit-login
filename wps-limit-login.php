...
// Plugin constants
define( 'WPS_LIMIT_LOGIN_VERSION', '1.4.9' );
...
if ( ! function_exists( 'plugins_loaded_wps_limit_login_plugin' ) ) {
	...
	function plugins_loaded_wps_limit_login_plugin() {
		...
		$message = __( 'Do you like plugin WPS Limit Login? <br> Thank you for taking a few seconds to note us on', 'wps-limit-login' );
		if( 'fr_FR' === get_locale() ) {
			$message = 'Vous aimez l\'extension WPS Limit Login ?<br>Merci de prendre quelques secondes pour nous noter sur';
		}
